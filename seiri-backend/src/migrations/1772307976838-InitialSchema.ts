...
export class InitialSchema1772307976838 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "users" ADD CONSTRAINT "UQ_ffc1e12ddff770c3b3be2e4391e" UNIQUE ("root_folder_id")',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "fileMetadata" ADD CONSTRAINT "FK_eb5aebc914ff0687db0eb3db79d" FOREIGN KEY ("item_id") REFERENCES "file_system_items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION',
    );
    await queryRunner.query(
      'ALTER TABLE "file_system_items" ADD CONSTRAINT "FK_a96f8d02d2344ef12ddf56f524d" FOREIGN KEY ("owner_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION',
    );
    await queryRunner.query(
      'ALTER TABLE "file_system_items" ADD CONSTRAINT "FK_9f2f8eebaf1c8bf19f7b5a3d1a0" FOREIGN KEY ("parent_id") REFERENCES "file_system_items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION',
    );
    await queryRunner.query(
      'ALTER TABLE "users" ADD CONSTRAINT "FK_ffc1e12ddff770c3b3be2e4391e" FOREIGN KEY ("root_folder_id") REFERENCES "file_system_items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION',
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "file_system_items" DROP CONSTRAINT "FK_9f2f8eebaf1c8bf19f7b5a3d1a0"',
    );
    await queryRunner.query(
      'ALTER TABLE "file_system_items" DROP CONSTRAINT "FK_a96f8d02d2344ef12ddf56f524d"',
    );
    await queryRunner.query(
      'ALTER TABLE "fileMetadata" DROP CONSTRAINT "FK_eb5aebc914ff0687db0eb3db79d"',
    );
    await queryRunner.query(
      'ALTER TABLE "users" DROP CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433"',
    );
    ...
    await queryRunner.query(
      'ALTER TABLE "users" DROP CONSTRAINT "UQ_ffc1e12ddff770c3b3be2e4391e"',
    );
